...
from .gemma2_seq import FastGemma2ModelSequenceClassification
...
class FastLanguageModel(FastLlamaModel):
    ...
    def from_pretrained(
        ...
        *args, **kwargs,
        ...
        elif model_type == "gemma2" and sequence_classification == True: dispatch_model = FastGemma2ModelSequenceClassification
        ...
        if sequence_classification is True and num_labels is not None:
